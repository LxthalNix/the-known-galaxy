...
export const eventSchema = z.object({
    ...
    factions: z.array(z.enum(Object.keys(factions) as [keyof typeof factions, ...Array<keyof typeof factions>])).min(1),
    types: z.array(z.enum(eventTypes)).default([]),
    ...
    submissionIssue: z.number().int().positive().optional(),
    submissionBodySha: z.string().regex(/^[a-f0-9]{64}$/).optional(),
